...
developer: bool  # Changed to True or False in the init code.
...
def say_attribute_transition_callback(*args):
    return (
        renpy.config.say_attribute_transition,
        renpy.config.say_attribute_transition_layer,
    )
...
containers_pass_transform_events = {
    "hover",
    "idle",
    "insensitive",
    "selected_hover",
...
def init():
    ...
    autoreload_functions = [
        (
            r"\.(png|jpg|jpeg|webp|gif|tif|tiff|bmp|avif|svg)$",
            renpy.exports.flush_cache_file,
        ),
